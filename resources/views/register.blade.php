            ...
            <div class="row flex-grow">
                <div class="col-lg-4 mx-auto">
                    <div class="auth-form-light text-left p-5">
                        ...
                        <h4>Admin Sign Up</h4>
                        <form class="pt-3" method="post" id="register_form" action="{{url('/auth/login')}}">
                            ...
                            <div class="form-group">
                                <input type="password" name="data[confirm_password]" class="form-control form-control-lg" id="exampleInputconfirm" placeholder="Confirm Password">
                            </div>
                            <div class="mt-3 text-center">
                                <a class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn" href="javascript:Register.actionRegister()">SIGN UP</a>
                                <a class="btn btn-block btn-gradient-info btn-lg font-weight-medium auth-form-btn" href="javascript:location.href='/'">Login</a>
                            </div>
                        </form>
                    </div>
                </div>
